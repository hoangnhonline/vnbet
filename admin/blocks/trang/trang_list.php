...
<div>
    <div>
        <div style="width: 48%;float: left"><h3>Quản lý trang : Xem danh sách</h3></div>
                ...
                <tbody>
                    ...
                    while ($row_trang = mysql_fetch_assoc($list_trang)) {
                        ...
                        <tr <?php if ($i % 2 == 0) echo "bgcolor='#CCC'"; ?>>
                            ...
                            &nbsp;&nbsp;
                                <img class="linkxoa" idTrang="<?php echo $row_trang['idTrang'] ?>" src="../img/icons/trash.png" alt="Xóa" title="Xóa" border="0"></td>
