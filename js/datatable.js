...
(/** @lends <global> */function($, window, document, undefined) {
	...
	var DataTable = function( oInit )
	{
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			sSearchStr = (sSearchStr.indexOf('_INPUT_') !== -1) ?
			  sSearchStr.replace('_INPUT_', '<input type="text" class="input" />') :
			  sSearchStr==="" ? '<input type="text" class="input" />' : sSearchStr+' <input type="text" class="input"/>';
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sInfo": "<i>Đang xem _START_ tới _END_ trong _TOTAL_ dòng</i>",
			 ...
			 *    } );
			 */
			"sInfoEmpty": "Đang xem từ 0 tới 0 trong 0 dòng",
